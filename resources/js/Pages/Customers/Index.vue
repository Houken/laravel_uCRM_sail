                                ...
                                <table class="w-full text-left whitespace-no-wrap table-auto">
                                    ...
                                    <tbody>
                                        <tr v-for="customer in customers.data" :key="customer.id">
                                            <td class="px-4 py-1 text-sm border-b-2 border-gray-200">{{ customer.id }}</td>
                                            <td class="px-4 py-1 text-sm border-b-2 border-gray-200">{{ customer.name }}</td>
                                            <td class="px-4 py-1 text-sm border-b-2 border-gray-200">{{ customer.kana }}</td>
